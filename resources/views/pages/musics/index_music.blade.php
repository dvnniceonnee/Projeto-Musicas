        ...
        <div class="container-fluid ps-2 bg-gray rounded-3 ">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-5 d-flex flex-column">
                        ...
                        <div class="card-body text-white d-flex flex-column justify-content-end py-0">
                            ...
                            <h5 class="card-title">Band : <a href="{{route('index_band', $music->band_id)}}">{{$music->band_name}}</a></h5>
                            <h5 class="card-title">Length : {{$music->length}} min </h5>
                            <h5 class="card-title">Album : <a href="{{route('index_album', $music->album_id)}}">{{$music->album_name}}</a></h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="d-flex flex-column mt-5">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="row p-0 mt-3">
                        @foreach($similarMusics as $music)
