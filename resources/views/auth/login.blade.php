...
@section('content')
    <div class="mt-3 loginBackground rounded py-5 vh-100">
        <div class="d-flex flex-column flex-md-row col-10 my-auto h-100 m-auto">
            <div
                class="d-flex align-items-center col-10 col-md-5 bg-white rounded-start py-5 px-2 mx-auto text-center me-md-0 ">
                <div class="d-flex flex-column my-5 w-75 mx-auto">
                    ...
                    <div class="alert alert-danger mt-2" role="alert">
                        Credentials do not match our information!
                    </div>
                    @enderror
                    <form class="my-auto mt-4" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-3 text-start">
                            <a href="{{route('password.request')}}">Esqueceste-te da password?</a>
                        </div>
            ...
            <div
                class="d-flex align-items-center col-10 col-md-3 bg-gray text-white text-center rounded-end ms-md-0 mx-auto">
